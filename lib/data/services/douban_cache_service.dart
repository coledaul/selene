...
class DoubanCacheService {
  ...
  Future<void> init() async {
    try {
      ...
      AppLogger.debug('豆瓣缓存服务初始化失败', error: e);
    }
  }
      ...
      if (_cacheDir != null) {
        ...
        if (await file.exists()) {
          try {
            ...
            final cacheItem = CacheItem.fromJson<dynamic>(
              jsonData,
              (data) => data,
            );
  ...
  Future<void> set<T>(String key, T data, Duration expiration) async {
    try {
      ...
      AppLogger.debug('设置豆瓣缓存失败', error: e);
    }
  }
  ...
  Future<void> delete(String key) async {
    try {
      ...
      AppLogger.debug('删除豆瓣缓存失败', error: e);
    }
  }
  ...
  Future<void> _cleanExpiredCache() async {
    try {
      ...
      AppLogger.debug('清理过期豆瓣缓存失败', error: e);
    }
  }
  ...
  Future<void> clearAll() async {
    try {
      ...
      AppLogger.debug('清空所有豆瓣缓存失败', error: e);
      rethrow;
    }
  }
  ...
  String generateDoubanDetailsCacheKey({required String doubanId}) {
    return _generateCacheKey('douban_details', {'doubanId': doubanId});
  }

  /// 为 Bangumi 详情数据生成缓存键
  String generateBangumiDetailsCacheKey({required String bangumiId}) {
    return _generateCacheKey('bangumi_details', {'bangumiId': bangumiId});
  }
}
