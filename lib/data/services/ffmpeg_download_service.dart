...
class DownloadProbeResult {
  const DownloadProbeResult({this.durationMs, this.isLiveStream = false});
...
abstract interface class VideoDownloadEngine {
  ...
  Future<void> verify({required String taskId, required String filePath});
...
class FfmpegDownloadEngine implements VideoDownloadEngine {
  ...
  static bool _isSafeHeaderName(String value) =>
