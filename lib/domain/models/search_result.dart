...
/// WebSocket 搜索事件类型
enum SearchEventType { start, sourceResult, sourceError, complete }
...
abstract class SearchEvent {
  ...
  SearchEvent({required this.type, required this.timestamp});
...
class SearchStartEvent extends SearchEvent {
  ...
  }) : super(type: SearchEventType.start);
...
class SearchSourceResultEvent extends SearchEvent {
  ...
  SearchSourceResultEvent({
    ...
    required super.timestamp,
  }) : super(type: SearchEventType.sourceResult);
...
class SearchSourceErrorEvent extends SearchEvent {
  ...
  SearchSourceErrorEvent({
    ...
    required this.error,
    required super.timestamp,
  }) : super(type: SearchEventType.sourceError);
...
class SearchCompleteEvent extends SearchEvent {
  ...
  SearchCompleteEvent({
    ...
    required super.timestamp,
  }) : super(type: SearchEventType.complete);
