...
class SearchResultsGrid extends StatefulWidget {
  ...
  final bool Function(String source, String id) isFavorited;
            ...
            return AnimatedContainer(
              ...
              child: VideoCard(
                ...
                onGlobalMenuAction: widget.onGlobalMenuAction != null
                    ...
                    : null,
                isFavorited: widget.isFavorited(videoInfo.source, videoInfo.id),
              ),
            );
          },
        );
  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          const Icon(Icons.search_off, size: 80, color: Color(0xFFbdc3c7)),
