...
class _FullscreenImageViewerState extends State<FullscreenImageViewer> {
  ...
  void _showSaveImageMenu() {
    showModalBottomSheet(
      ...
      builder: (context) => Consumer<ThemeViewModel>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    title: Text(
                      '保存到相册',
                      style: FontUtils.poppins(color: textColor, fontSize: 16),
                    ),
                    onTap: () {
                  ...
                  ListTile(
                    leading: Icon(Icons.close, color: secondaryTextColor),
                    title: Text(
                      '取消',
                      style: FontUtils.poppins(
  ...
  Future<bool> _checkStoragePermission() async {
    try {
      ...
      AppLogger.debug('检查相册权限失败', error: e);
      return false;
    }
  }
  ...
  Future<void> _saveImageToGallery() async {
    ...
    try {
      ...
      // 显示保存提示
      if (mounted) {
        final themeService = Provider.of<ThemeViewModel>(
          context,
          listen: false,
        );
        final isDark = themeService.isDarkMode;
  ...
  Future<Uint8List?> _getCachedImageBytes() async {
    try {
      ...
      AppLogger.debug('读取缓存图片失败', error: e);
      return null;
    }
  }
