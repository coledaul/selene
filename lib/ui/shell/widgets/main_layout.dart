...
class _MainLayoutState extends State<MainLayout> {
  ...
  // 搜索建议相关状态
  List<String> get _searchSuggestions => widget.viewModel.state.suggestions;
  ...
  void _onSearchQueryChanged(String query) {
    ...
    widget.viewModel.updateQuery(query);
  }
  ...
  Widget _buildHeader(BuildContext context, ThemeViewModel themeService) {
    final isTablet = DeviceUtils.isTablet(context);
  ...
  Widget _buildNormalHeader(BuildContext context, ThemeViewModel themeService) {
    return SizedBox(
          ...
          child: TextField(
            ...
            onTap: () {
              ...
              if (widget.searchQuery?.trim().isNotEmpty ?? false) {
                widget.viewModel.updateQuery(widget.searchQuery!);
              }
            },
          ),
        ),
  ...
  Widget _buildRightButtons(ThemeViewModel themeService) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
        // 深浅模式切换按钮
  ...
  Widget _buildBottomNavBar(ThemeViewModel themeService) {
